    ...
    <form id="form1" runat="server">
        ...
        <asp:MultiView ID="mlvw" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="vw1" runat="server">
                <img class="u-image u-image-default u-image-1" src="/assets/img/Quiz/1.jpg" alt="" data-image-width="1280" data-image-height="1000">
                <br /><br /><br />  <br />

             <center><asp:Button ID="StartQuiz" class="button fire" runat="server" Text="Check Knowlegde" OnClick="StartQuiz_Click" /></center>
            ...
            <img class="u-image u-image-default u-image-1" src="/assets/img/Quiz/q1.jpg" alt="" data-image-width="1280" data-image-height="852">
                <br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:View ID="vw3" runat="server">
              ...
              <img class="u-image u-image-default u-image-1" src="/assets/img/Quiz/q2.jpg" alt="" data-image-width="1280" data-image-height="852">
                <br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:View ID="vw7" runat="server">
              <center>  <h2> Result & Review</h2></center>
                <br />
             <center><asp:Label class="hcqStyle3" ID="Result1" runat="server" font-size="Larger"></asp:Label></center>
                <br />
       ...
       <div class="u-align-left u-container-style u-expanded-width u-group u-palette-3-base u-group-6">
              <div class="u-container-layout u-container-layout-6">
                ...
                <br />
                <asp:Label ID="Label3" CssClass="text" runat="server" Text="B.	Endangered."  ></asp:Label>
                <br />
              ...
              <div class="u-container-layout u-container-layout-6">
                ...
                <br />
                <asp:Label ID="Label11" CssClass="text" runat="server" Text="C.	ALPS"  ></asp:Label>
                <br />
              ...
              <div class="u-container-layout u-container-layout-6">
                ...
                <br />
                <asp:Label ID="Label17" CssClass="text" runat="server" Text="B. 91"  ></asp:Label>
                <br />
              ...
              <div class="u-container-layout u-container-layout-6">
                ...
                <br />
                <asp:Label ID="Label25" CssClass="text" runat="server" Text="C. Desert"  ></asp:Label>
                <br />
              ...
              <div class="u-container-layout u-container-layout-6">
                ...
                <br />
                <asp:Label ID="Label30" CssClass="text" runat="server" Text="A. Light pollution"  ></asp:Label>
                <br />
                ...
                <asp:Label ID="Label35" runat="server" Text="The main modern causes of extinction are the loss and degradation of habitat (mainly deforestation), over exploitation (hunting, overfishing), invasive species, climate change, and nitrogen pollution."></asp:Label>
                     ...
                     <br /><br />
            <center><asp:Button ID="Restart" class="button ice" runat="server" Text="Restart" OnClick="Restart_Click" /></center>
            <right> <asp:Button ><a class = 'button' href="/Home/kolaroo">Back To Home</a></asp:Button>
