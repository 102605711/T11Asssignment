...
<body class="u-body u-xl-mode">
        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown">
                       ...
                       <li class="dropdown">
                        <a href="/Home/JoinUS"><span>Get Involved</span> </a>
                        <ul>
         ...
         <section id="hero" style="height: 60vh; background:url('assets/quizBack1.jpg') top center ; ">
    ...
    <div class="title">
        <h4>From doing the quiz to check about what you grabbed from our website!</h4>
        </div>
    <section class="u-align-center u-clearfix u-image u-section-1" data-image-width="2000 data-image-height="1500" id="sec-0106" padding="0">
    ...
    <asp:ScriptManager runat="server"></asp:ScriptManager>
        ...
        <asp:MultiView ID="mlvw" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="vw1" runat="server">
                <br /><br />
                <img class="u-image u-image-default u-image-1" src="assets/QuizCard.jpg" alt="" data-image-width="1280" data-image-height="1000">
     ...
     <br />
             ...
             <center><asp:Button ID="StartQuiz" class="btn btn-primary btn-lg" runat="server" Text="Check Knowledge" forecolor="White" OnClick="StartQuiz_Click" /></center>
            ...
            <asp:View ID="vw2" runat="server">
             ...
             <asp:Image ID="Image1" runat="server" class="u-image u-image-default u-image-1" alt="" data-image-width="1280" data-image-height="852"></asp:Image>
                <br />
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:View ID="vw3" runat="server">
              ...
              <asp:Image ID="Image2" runat="server" class="u-image u-image-default u-image-1" alt="" data-image-width="1280" data-image-height="852"></asp:Image>
                <br /><div class="bar" style="--precent:40;"></div>
                <br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:View ID="vw4" runat="server">
              ...
              <asp:Image ID="Image3" runat="server" class="u-image u-image-default u-image-1" alt="" data-image-width="1280" data-image-height="852"></asp:Image>
                <br /><div class="bar" style="--precent:60;"></div>
                <br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:View ID="vw5" runat="server">
                  ...
                  <asp:Image ID="Image4" runat="server" class="u-image u-image-default u-image-1" alt="" data-image-width="1280" data-image-height="852"></asp:Image>
                <br /><div class="bar" style="--precent:80;"></div>
                <br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:View ID="vw6" runat="server">
                  ...
                  <asp:Image ID="Image5" runat="server" class="u-image u-image-default u-image-1" alt="" data-image-width="1280" data-image-height="852"></asp:Image>
                <br /><div class="bar" style="--precent:100;"></div>
                <br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <asp:Button class="u-border-2 u-border-palette-1-base u-btn u-btn-round u-button-style u-hover-palette-1-base u-none u-radius-6 u-text-hover-white u-text-palette-1-base u-btn-2" ID="n6" runat="server" Text="Result" OnClick="n6_Click" />
       ...
       <div class="u-align-left u-container-style u-expanded-width u-group u-palette-3-base u-group-6">
              <div class="u-container-layout u-container-layout-6">
                ...
                <br />
                <asp:Label ID="Label3" runat="server" Text="B.	Endangered."  ></asp:Label>
                <br />
                ...
                <asp:Label ID="Label7" runat="server" Text="The threatened status of Southern Brown Bandicoot is endangered."></asp:Label>
                  <br />
                  <asp:Label ID="Label36" runat="server" Text="Want know more? "></asp:Label>
                  <asp:HyperLink ID="HyperLink1" runat="server" Target="_blank">Explore Now!</asp:HyperLink>
              </div>
            </div>
              ...
              <div class="u-container-layout u-container-layout-6">
                ...
                <br />
                <asp:Label ID="Label11" runat="server" Text="C.	ALPS"  ></asp:Label>
                <br />
                ...
                <asp:Label ID="Label14" runat="server" Text="The Booroolong Frog lives in The ALPS."></asp:Label>
                          <br />
                  <asp:Label ID="Label37" runat="server" Text="Want know more? "></asp:Label>
                  <asp:HyperLink ID="HyperLink2" runat="server" Target="_blank">Explore Now!</asp:HyperLink>
              </div>
            </div>
              ...
              <div class="u-container-layout u-container-layout-6">
                ...
                <br />
                <asp:Label ID="Label17"  runat="server" Text="B. 91"  ></asp:Label>
                <br />
                ...
                <asp:Label ID="Label21" runat="server" Text="There are 91 endangered animals species lived in Victoria Australia, but there are 43 endangered land animals lived in Victoria."></asp:Label>
                          <br />
                  <asp:Label ID="Label38" runat="server" Text="Want know more? "></asp:Label>   
                  <asp:HyperLink ID="HyperLink3" runat="server" Target="_blank">Explore Now!</asp:HyperLink>
              </div>
            </div>
              ...
              <div class="u-container-layout u-container-layout-6">
                ...
                <br />
                <asp:Label ID="Label25"  runat="server" Text="C. Desert"  ></asp:Label>
                <br />
                ...
                <asp:Label ID="Label28" runat="server" Text="There are four main endangered habitats in Victoria: Grasslands, The ALPS, Forest and Rainforest and Dry forest and woodlands."></asp:Label>
                      <br />
                  <asp:Label ID="Label39" runat="server" Text="Want know more? "></asp:Label>
                  <asp:HyperLink ID="HyperLink4" runat="server" Target="_blank">Explore Now!</asp:HyperLink>
              </div>
            </div>
              ...
              <div class="u-container-layout u-container-layout-6">
                ...
                <br />
                <asp:Label ID="Label30"  runat="server" Text="A. Light pollution"  ></asp:Label>
                <br />
                ...
                <asp:Label ID="Label35" runat="server" Text="The main modern causes of extinction are the loss and degradation of habitat (mainly deforestation), over exploitation (hunting, overfishing), invasive species, climate change, and nitrogen pollution."></asp:Label>
                      <br />
                  <asp:Label ID="Label40" runat="server" Text="Want know more? "></asp:Label>
                  <asp:HyperLink ID="HyperLink5" runat="server" Target="_blank">Explore Now!</asp:HyperLink>
              </div></div>
                     <br /><br />
            <center><asp:Button ID="Restart" class="btn btn-primary btn-lg" runat="server" Text="Restart" forecolor="White" OnClick="Restart_Click" /></center>
                <br />
           <center>  <a href="/Home/kolaroo" type="button" class="btn btn-danger">Back Home</a></center>
